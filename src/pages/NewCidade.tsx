...
const NewCidade = () => {
    ...
    const [cidCodIbge ,setCidCodIbge] = useState(''); 
    ...
    async function handleRefreshToken(){
      await api({
          ...
          alert(`Falha no token de cadastro de cidades`);
          Router.push({
              pathname: '/',        
          })      
      })
                  ...
                  <div className='md:p-12 md:mx-6'>
                    <div className='text-center'>
                      <h4 className='text-xl font-semibold mt-1 mb-12 pb-1'>
                        Formulário Cadastro de Cidades
                      </h4>
                    </div>
                    <form className='ml-5 mr-5 '>                       
                      ...
                      <div className='mb-4'>                        
                        <input
                          ...
                          name='cidCodIbge'
                          value={cidCodIbge} 
                          onChange={(e) => {setCidCodIbge(e.target.value)}} 
                        />
                      </div>
